...
//Mongodb setup
const URI = "mongodb+srv://root:root@cluster0.7ywqk.mongodb.net/<dbname>?retryWrites=true&w=majority";
...
app.get("/donate", function(req, res) {
    res.sendFile(__dirname+"/donate/index.html");
});
...
// app.get("/*", function(req, res) {
//     res.render("<h1>page not avaialble</h1>")
// });
...
io.on('connection', (socket) => {
    ...
    socket.on('host-join', (data) =>{
        ...
        //Check to see if id passed in URI corresponds to id of kahoot game in database
        MongoClient.connect(URI, function(err, db) {
            ...
            dbo.collection('kahootGames').find(query).toArray(function(err, result){
                ...
                //A kahoot was found with the id passed in URI
